...
class res_partner(osv.osv, format_address):
    ...
    _columns = {
        ...
        'type': fields.selection([('default','Default'), ('delivery','Delivery'), ('contact','Contact'), ('other','Other'), ('order_dispatch_address','Order Dispatch Address'), ('invoice_dispatch_address','Invoice Dispatch Address')], 'Address Type', help="Used to select automatically the right address according to the context in sales and purchases documents."),
